package com.congda.jianxin.mvp.ui;
 ...
 */
public abstract class IMBaseActivity<P extends IPresenter> extends BaseActivity implements IActivity, ActivityLifecycleable, IView {
    ...
    /**
     * 这个 {@link Activity} 是否会使用 {@link }, 框架会根据这个属性判断是否注册 {@link android.support.v4}
     * 如果返回 {@code false}, 那意味着这个 {@link Activity} 不需要绑定 {@link }, 那你再在这个 {@link Activity} 中绑定继承于 {@link BaseFragment} 的 {@link } 将不起任何作用
     *
     * @return 返回 {@code true} (默认为 {@code true}), 则需要使用 {@link }
     */
    @Override
