...
public class IMRoundAngleImageView extends ImageView {
     ...
     * 这两个都是画圆的半径
     */
    private int roundWidth = IMDensityUtil.dip2px(getContext(),7);
    private int roundHeight =  IMDensityUtil.dip2px(getContext(),7);
    private Paint paint2;

    public IMRoundAngleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public IMRoundAngleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
